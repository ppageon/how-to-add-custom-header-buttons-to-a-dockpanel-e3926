...
Namespace CustomHeaderButtonsExample
    Partial Public Class Form1
        ...
        Private Sub panelContainer1_CustomButtonChecked(ByVal sender As Object, ByVal e As DevExpress.XtraBars.Docking2010.ButtonEventArgs)
            If e.Button = panelContainer1.CustomHeaderButtons(4) Then
            ...
            End If
            If e.Button = panelContainer1.CustomHeaderButtons(3) Then
            ...
            End If
            If e.Button = panelContainer1.CustomHeaderButtons(2) Then
            ...
            End If
            If e.Button = panelContainer1.CustomHeaderButtons(1) Then
